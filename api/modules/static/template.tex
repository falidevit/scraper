...
\begin{center}
    ...
    \small \raisebox{-0.1\height}\faPhone\ phone_number ~ \href{mailto:x@gmail.com}{\raisebox{-0.2\height}\faEnvelope\  \underline{email@gmail.com}} ~ 
...
\section{Education}
  \resumeSubHeadingListStart
    \resumeSubheading
      {university_name}{2020 -- 2024}
      {degree} {Iowa City, Iowa}
